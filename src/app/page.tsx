export default function Page() {
  return (
    <main className="px-8 py-24 prose max-w-prose mx-auto">
      <h1>anthropoc.com is for sale</h1>
      <p>I purchased anthropoc.com back in 2020 because I thought Anthropoc was a great brandable word with some strong potential for attached meaning.</p>
